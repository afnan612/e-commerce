                    ...
                    <ul>
                        <li>
                            <a href="#" target="_blank">
                                <img src="assets/site/images/payment1.png" alt="Payment">
                            </a>
                        </li>
                        <li>
                            <a href="#" target="_blank">
                                <img src="assets/site/images/payment2.png" alt="Payment">
                            </a>
                        </li>
                        <li>
                            <a href="#" target="_blank">
                                <img src="assets/site/images/payment3.png" alt="Payment">
                            </a>
                        </li>
                        <li>
                            <a href="#" target="_blank">
                                <img src="assets/site/images/payment4.png" alt="Payment">
                            </a>
                        </li>
                    </ul>
                </div>
